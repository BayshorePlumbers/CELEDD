            ...
            <body>
                <div class="container">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>${sw}</td><td>${wh}</td><td>${rd}</td><td>${ss}</td><td>${bpp}</td>
                        </tr>
                    </table>
                    <div class="commission-details-section">
                    <h3>COMMISSION DETAILS:</h3>
                    <table>
                        <tr><th>Technician Commission (Total):</th><td>${commission}</td></tr>
                        <tr><th>Technician Commission (Eddie):</th><td>${tech1}</td></tr>
                        <tr><th>Technician Commission (Celso):</th><td>${tech2}</td></tr>
                    </table>
                    </div>
                </div>
            </body>
